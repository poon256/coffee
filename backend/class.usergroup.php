				...
				<table class='table table-bordered table-striped'>
					...
					<?php
                        ...
                        while ($cdr = $res->fetch())
                        {
							...
							if ($cdr['cc'] == '4')
							{
								echo "<option value='4' selected>Approve</option>";
							}
							else
							{
							...
							if ($cdr['cc'] == '5')
							{
								echo "<option value='5' selected>Read + Approve</option>";
							}
							else
							{
								echo "<option value='5'>Read + Approve</option>";
							}
							if ($cdr['cc'] == '6')
							{
								echo "<option value='6' selected>Write + Approve</option>";
							}
							else
							{
								echo "<option value='6'>Write + Approve</option>";
							}
							if ($cdr['cc'] == '7')
							{
								echo "<option value='7' selected>Full Access</option>";
							}
							else
							{
								echo "<option value='7'>Full Access</option>";
							}
							echo "</select>";
